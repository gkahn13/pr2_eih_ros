...
class HandlePosesPublisher:
    def __init__(self, handle_topic='/handle_detector/handle_list'):
        ...
        # for box
#         self.min_positions = np.array([0.28,-0.9,0.7])
#         self.max_positions = np.array([0.7,0.2,0.86])
        
        # for kitchen
#         self.min_positions = np.array([0.48,-0.9,0.68])
#         self.max_positions = np.array([0.8,0.2,0.92])
        
        # for shelf
        self.min_positions = np.array([0.3,-0.9,1.18])
